...
var stockInsightService = new StockInsightService(stockService, stockAnalyticsService);
...
var mainCommands = new List<ICommand>
{
    ...
    new StockMenuCommand(stockService, stockAnalyticsService, stockInsightService)
